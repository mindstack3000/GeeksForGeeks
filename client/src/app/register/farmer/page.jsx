...
function FarmerRegister() {
  ...
  const handleSubmit = async (e) =>{
    try{
      ...
      if(form.address === "" || form.adharNo === "" || form.email === "" || form.fullName === "" || form.password === "" || form.phoneNo === "" || form.username === "" || form.landSize === "" || form.typeOfCrop.length === 0){
    ...
    <>
      ...
      <div className="flex h-[85%] w-full flex-col items-start justify-start gap-5  rounded-lg border border-input p-10 ">
        ...
        <div className="mt-10 flex w-full flex-col items-center justify-center gap-5 ">
          <InputWithLabel label="Aadhar Card No" onChange={(e)=>handleChange(e,"adharNo")}/>
          <InputWithLabel label="Fullname" onChange={(e)=>handleChange(e,"fullName")}/>
          <InputWithLabel label="Username" onChange={(e)=>handleChange(e,"username")}/>
          <InputWithLabel label="Password" type="password" onChange={(e)=>handleChange(e,"password")}/>
          <InputWithLabel label="Phone No." type="text"  onChange={(e)=>handleChange(e,"phoneNo")}/>
          <InputWithLabel label="Email" type="text"onChange={(e)=>handleChange(e,"email")}/>
          <InputWithLabel label="Address" type="text"  onChange={(e)=>handleChange(e,"address")}/>
          <InputWithLabel label="Land Size " onChange={(e)=>handleChange(e,"landSize")}/>
